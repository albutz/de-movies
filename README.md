...
- The transformation step (`dbt run`) builds dimensional tables and a fact table that combines IMDB ratings and NYT reviews. Also, a data mart is built to analyze ratings and reviews by genre over time and can serve downstream BI applications.
- All tables and views thoroughly covered with data quality tests via `dbt test`.
